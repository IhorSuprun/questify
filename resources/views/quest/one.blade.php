    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div>
                    <!--                    TODO сделать проверку, после которой выводить следующие варианты:
                                        - кнопка "Приступить"
                                        - сообщение "Вы являетесь автором и не можете приступить"
                                        - Кнопки "Завершить" или "Отменить" если квест взят на выполнение-->
                </div>
            </div>
        </div>
    </div>
