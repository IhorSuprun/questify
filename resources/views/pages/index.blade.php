...
<!--<div id="boxWrapp">
	...
	<a href="#" class="closed">(<i class="fa fa-times"></i>)</a>
		<ul>
			...
			<li><a href="#recipes">BROWSE THE RECIPES</a></li>
		</ul>
	</nav>-->
	<!-- content -->
				...
				<div class="col-sm-6 col-md-6 col-lg-6">
					<div class="main-nav clearfix">
						<div class="btn-group pull-right">
						  <a href="/login"><button type="button" class="btn btn-link">Вход</button></a>
						  <a href="/register"><button type="button" class="btn btn-link">Регистрация</button></a>
<!--						  <button type="button" class="btn btn-link navToggle"><i class="fa fa-bars"></i></button>-->
						</div>
					</div>
				</div><!-- end col -->
			</div><!-- end row -->
	...
	<section class="main-header">
		<div class="main-head text-center">
			...
			<p class="top animated hidding" data-animated="bounceInUp">Начни свой</p>
			<h1 class="animated hidding delay2" data-animated="bounceInUp">КВЕСТ</h1>
			<a href="/main" class="btn btn-clear animated hidding delay3 about-more" data-animated="bounceInUp">НАЧАТЬ</a>
			<p class="animated hidding delat4" data-animated="bounceInUp">Разгадывай квесты других пользователей и создавай свои собственные</p>
		</div><!-- end main head -->
	</section>
	<!-- end content -->
...
libero dui, eleifend eu nisi id, egestas fringilla odio. In varius quam a massa hendrerit ullamcorper a eu justo. Suspendisse porta mattis convallis. Aenean tempus ligula ac odio rhoncus, quis aliquam dolor accumsan.</p>
	...
	<section class="page-img" id="testimonial">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 animated hidding" data-animated="bounceInUp">
